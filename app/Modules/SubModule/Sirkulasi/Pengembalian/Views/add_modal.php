		...
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">
					<i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Tambah Pengembalian
				</h5>
					...
					<div class="form-row">
						<div class="col-lg-6">
							<div class="form-group">
								...
								<div>
									<input required type="text" class="form-control" id="frm_add_pengembalian" name="pengembalian" placeholder="Pengembalian" value="" />
								</div>
							</div>
						</div>
						<div class="col-lg-6">
...
<script>
	$('#frm_add').submit(function(event) {
		...
		var url = "<?= base_url('api/sirkulasi-pengembalian/create') ?>";
		...
		$.ajax({
			...
			.done(function(res) {
				...
				if (res.error == false) {
					Swal.fire({
						title: 'Berhasil',
						html: 'Pengembalian berhasil ditambah.',
						type: 'success',
