    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Jenis Denda
                    <div class="page-title-subheading">Daftar semua Jenis Denda</div>
                </div>
            </div>
            <div class="page-title-actions">
                <nav class="" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?= base_url('jenisdenda') ?>"><i class="fa fa-home"></i> Home</a></li>
...
<?= $this->section('script'); ?>
<?= $this->include('JenisDenda\Views\add_modal'); ?>
<?= $this->include('JenisDenda\Views\update_modal'); ?>
<script>
    var t;
