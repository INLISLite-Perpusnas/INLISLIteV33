<div class="modal fade" id="modal_update" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="frm_update" method="post" data-action="<?= base_url('api/jenis-denda/edit') ?>" data-id="">
					...
					<div class="form-row">
						<div class="col-lg-12">
							<div class="form-group">
								...
								<div>
									<input required type="text" class="form-control" id="frm_update_kode" name="Code" placeholder="Code" value="" />
								</div>
							</div>
						</div>
					</div>
					...
					<div class="form-row">
						<div class="col-lg-12">
							<div class="form-group">
								...
								<div>
									<input required type="text" class="form-control" id="frm_update_Name" name="Name" placeholder="Jenis Denda" value="" />
								</div>
							</div>
						</div>
					</div>
	...
	$("body").on("click", ".show-data", function() {
        ...
        $.ajax({
            ...
            success: function(response) {
				...
				$('#frm_update_kode').val(response.Code);
