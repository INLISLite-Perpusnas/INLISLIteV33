		...
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">
					<i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Tambah Jenis Akses
				</h5>
					...
					<div class="form-row">
						<div class="col-lg-12">
							<div class="form-group">
								...
								<div>
									<input required type="text" class="form-control" id="frm_add_Nama" name="Name" placeholder="Jenis Akses" value="" />
								</div>
							</div>
						</div>
					</div>
...
<script>
	$('#frm_add').submit(function(event) {
		...
		var url = "<?= base_url('api/master-jenis-akses/create') ?>";
