        ...
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Status Perkawinan
                    <div class="page-title-subheading">Daftar semua Status Perkawinan</div>
                </div>
            </div>
            <div class="page-title-actions">
                <nav class="" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?= base_url('statusperkawinan') ?>"><i class="fa fa-home"></i> Home</a></li>
                        <li class="active breadcrumb-item" aria-current="page">Status Perkawinan</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<?= $this->section('script'); ?>
<?= $this->include('StatusPerkawinan\Views\add_modal'); ?>
<?= $this->include('StatusPerkawinan\Views\update_modal'); ?>
<script>
    var t;
