        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Tambah Status Perkawinan
                </h5>
					...
					<div class="form-row">
						<div class="col-lg-12">
							<div class="form-group">
								...
								<div>
									<input required type="text" class="form-control" id="frm_add_Nama" name="Nama" placeholder="Status Perkawinan" value="" />
								</div>
							</div>
						</div>
					</div>
    ...
    $('#frm_add').submit(function(event) {
		...
		.done(function(res) {
			...
			if (res.error == false) {
				Swal.fire({
					title: 'Berhasil',
					html: 'Status Perkawinan berhasil ditambah.',
					type: 'success',
