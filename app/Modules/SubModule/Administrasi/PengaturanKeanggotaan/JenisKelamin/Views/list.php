    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Jenis Kelamin
                    <div class="page-title-subheading">Daftar semua Jenis Kelamin</div>
                </div>
            </div>
...
<?= $this->section('script'); ?>
<?= $this->include('JenisKelamin\Views\add_modal'); ?>
<?= $this->include('JenisKelamin\Views\update_modal'); ?>
<script>
    var t;
    $(document).ready(function() {
        t = $('#tbl_data').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": '<?php echo site_url('api/jenis-kelamin/datatable/' . $slug) ?>',
            },
