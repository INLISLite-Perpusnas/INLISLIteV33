        ...
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Jenis Pendidikan
                    <div class="page-title-subheading">Daftar semua Jenis Pendidikan</div>
                </div>
            </div>
...
<?= $this->section('script'); ?>
<?= $this->include('JenisPendidikan\Views\add_modal'); ?>
<?= $this->include('JenisPendidikan\Views\update_modal'); ?>
<script>
    var t;
    $(document).ready(function() {
        t = $('#tbl_data').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": '<?php echo site_url('api/jenis-pendidikan/datatable/' . $slug) ?>',
            },
