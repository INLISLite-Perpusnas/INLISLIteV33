...
<div class="app-main__inner">
    ...
    <div class="main-card mb-3 card col-md-8">
        <div class="card-header"><i class="header-icon lnr-list icon-gradient bg-plum-plate"> </i>Tabel Master Fakultas
            <div class="btn-actions-pane-right actions-icon-btn">
                   <a data-bs-toggle="modal" data-bs-target="#modal_create" data-toggle="modal" data-target="#modal_create" href="javascript:void(0);" class="btn btn-success" title="Tambah"><i class="fa fa-plus"></i>Master Fakultas</a>
            </div>
        </div>
        <div class="card-body">
            <?= get_message('message'); ?>
...
<?= $this->section('script'); ?>
<?= $this->include('MasterFakultas\Views\add_modal'); ?>
<?= $this->include('MasterFakultas\Views\update_modal'); ?>
<script>
    var t;
    $(document).ready(function() {
        t = $('#tbl_data').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": '<?php echo site_url('api/fakultas/datatable/' . $slug) ?>',
            },
