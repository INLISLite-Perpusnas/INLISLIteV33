...
<div class="app-main__inner">
	<div class="app-page-title">
		<div class="page-title-wrapper">
			<div class="page-title-heading">
				...
				<div>Template Kartu <?= ucwords(unslugify($slug)) ?>
			...
			<div class="page-title-actions">
				<nav class="" aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="active breadcrumb-item" aria-current="page">Tambah Template Kartu</li>
					</ol>
				</nav>
			</div>
		</div>
	...
	<div class="main-card mb-3 card">
		<div class="card-header">
			<i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Form Tambah Template Kartu
		</div>
		<div class="card-body">
			...
			<form id="frm_create" class="col-md-12 mx-auto" method="post" action="<?= base_url(
				...
				<div class="form-row">
					...
					<div class="col-md-4">
						<div class="position-relative form-group">
							<label for="title">Nama Template Kartu*</label>
							<div>
								<input type="text" class="form-control" name="title" id="title" placeholder="Judul Template Kartu " value="<?= set_value('title') ?>" />
							</div>
						</div>
					</div>
				</div>
