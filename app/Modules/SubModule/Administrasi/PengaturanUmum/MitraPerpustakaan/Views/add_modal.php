        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Tambah Mitra Perpustakaan
                </h5>
...
<script>
    $('#frm_add').submit(function(event) {
		...
		var url = "<?=base_url('api-mitra-perpustakaan/create')?>";
		...
		.done(function(res) {
			...
			if (res.error == false) {
				Swal.fire({
					title: 'Berhasil',
					html: 'Mitra Perpustakaan berhasil ditambah.',
					type: 'success',
