    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Jenis Perpustakaan
                    <div class="page-title-subheading">Daftar semua Jenis Perpustakaan</div>
                </div>
            </div>
...
<?= $this->section('script'); ?>
<?= $this->include('JenisPerpustakaan\Views\add_modal'); ?>
<?= $this->include('JenisPerpustakaan\Views\update_modal'); ?>
<?= $this->include('JenisPerpustakaan\Views\form_modal'); ?>
<script>
    var t;
    $(document).ready(function() {
        t = $('#tbl_data').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": '<?php echo site_url('api-jenis-perpustakaan/datatable/' . $slug) ?>',
            },
