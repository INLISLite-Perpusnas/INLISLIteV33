    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Media Koleksi
                    <div class="page-title-subheading">Daftar semua Media Koleksi</div>
                </div>
            </div>
            ...
            <table style="width: 100%;" id="tbl_data" class="table table-hover table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Media Koleksi</th>
...
<?= $this->section('script'); ?>
<?= $this->include('MediaKoleksi\Views\add_modal'); ?>
<?= $this->include('MediaKoleksi\Views\update_modal'); ?>
<script>
    var t;
