			...
			<div class="page-title-actions">
				<nav class="" aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Penomoran Koleksi</li>
					</ol>
				</nav>
			</div>
		</div>
		...
		<div class="col-md-6">
			<div class="main-card mb-3 card">
				<div class="card-header">
					<i class="header-icon lnr-pencil icon-gradient bg-plum-plate"> </i> Penomoran Koleksi
				</div>
				<div class="card-body">
					<div id="infoMessage"><?= $message ?? '' ?></div> <?= get_message('message') ?>
					<form id="frm_create" method="post" action="<?= base_url('master-penomoran-koleksi/index') ?>" onsubmit="return validateForm()">
						<div class="form-row">
							<div class="col-md-12">
								<div class="position-relative form-group">
									<label for="alias">Penomoran Koleksi Katalog*</label>
									<div>
										<?php $parameter = get_setting_parameter('PenomoranKoleksiKatalog', is_profiling()); ?>
