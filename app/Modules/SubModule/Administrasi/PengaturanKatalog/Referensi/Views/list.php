...
<div class="app-main__inner">
    ...
    <div class="main-card mb-3 card col-md-8">
        <div class="card-header"><i class="header-icon lnr-list icon-gradient bg-plum-plate"> </i>Tabel Referensi
            <div class="btn-actions-pane-right actions-icon-btn">
                <?php if (is_allowed('master-referensi/create')) : ?>
                    <a href="<?= base_url('master-referensi/create') ?>" class=" btn btn-success" title=""><i class="fa fa-plus"></i> Tambah </a>
                <?php endif; ?>
            </div>
        </div>
        <div class="card-body">
...
<script>
    ...
    $(document).ready(function() {
        t = $('#tbl_data').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": '<?php echo site_url('api/master-referensi/datatable/' . $slug) ?>',
            },
