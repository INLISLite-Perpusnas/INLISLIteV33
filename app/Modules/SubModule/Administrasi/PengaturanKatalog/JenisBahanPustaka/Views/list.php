    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Jenis Bahan Pustaka
                    <div class="page-title-subheading">Daftar semua Jenis Bahan Pustaka</div>
                </div>
            </div>
        ...
        <div class="card-header"><i class="header-icon lnr-list icon-gradient bg-plum-plate"> </i>Tabel Jenis Bahan Pustaka
            <div class="btn-actions-pane-right actions-icon-btn">
                <?php if (is_allowed('master-jenis-bahan-pustaka/create')) : ?>
                    <a href="<?= base_url('master-jenis-bahan-pustaka/create') ?>" class=" btn btn-success" title=""><i class="fa fa-plus"></i> Tambah </a>
                <?php endif; ?>
            </div>
        </div>
        <div class="card-body">
