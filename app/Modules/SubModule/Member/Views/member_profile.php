			...
			<div class="dropdown-menu-header">
				<div class="dropdown-menu-header-inner bg-night-sky text-light">
					<div class="menu-header-image"
						style="background-image: url('<?= base_url('themes/uigniter') ?>/images/dropdown-header/abstract2.jpg')">
					</div>
					<div class="menu-header-content btn-pane-right">
						...
						<div class="menu-header-btn-pane">
							<ul class="nav" id="nav_profile">
								<li class="nav-item"><a data-toggle="tab" href="#tab1"
										class="text-light nav-link show active ">Profil Anggota</a></li>
								<li class="nav-item"><a data-toggle="tab" href="#tab2"
										class="text-light nav-link show">Lokasi Perpustakaan</a></li>
								<li class="nav-item"><a data-toggle="tab" href="#tab3"
										class="text-light nav-link show">Kategori Koleksi</a></li>
							</ul>
						</div>
					</div>
				</div>
																...
																<div class="widget-content p-0">
																	<div class="widget-content-wrapper">
																		...
																		<div class="widget-content-left">
																			<div class="widget-heading">Nomor Anggota
																			</div>
																		</div>
																		<div
																			class="widget-content-right text-primary font-weight-bold">
																			<?= $member->MemberNo; ?>
																		</div>
																	</div>
																</div>
															...
															<li class="list-group-item">
																<div class="widget-content p-0">
																	<div class="widget-content-wrapper">
																		...
																		<div class="widget-content-left">
																			<div class="widget-heading">Nama Anggota
																			</div>
																		</div>
																		<div
																			class="widget-content-right text-primary font-weight-bold">
															...
															<li class="list-group-item">
																<div class="widget-content p-0">
																	<div class="widget-content-wrapper">
																		...
																		<div class="widget-content-left">
																			<div class="widget-heading">Jenis Kelamin
																			</div>
																		</div>
																		<div
																			class="widget-content-right text-primary font-weight-bold">
																			<?= esc($jenis_kelamin[$member->Sex_id] ?? '-') ?>
																		</div>
																	</div>
																</div>
															</li>
															<li class="list-group-item">
																<div class="widget-content p-0">
																	<div class="widget-content-wrapper">
																		...
																		<div class="widget-content-left">
																			<div class="widget-heading">Tanggal
																				Pendaftaran</div>
																		</div>
																		<div
																			class="widget-content-right text-primary font-weight-bold">
															...
															<li class="list-group-item">
																<div class="widget-content p-0">
																	<div class="widget-content-wrapper">
																		...
																		<div class="widget-content-left">
																			<div class="widget-heading">Tanggal Berlaku
																				Akhir</div>
																		</div>
																		<div
																			class="widget-content-right text-primary font-weight-bold">
															...
															<li class="list-group-item">
																<div class="widget-content p-0">
																	<div class="widget-content-wrapper">
																		...
																		<div class="widget-content-left">
																			<div class="widget-heading">Jenis Anggota
																			</div>
																		</div>
																		<div
																			class="widget-content-right text-primary font-weight-bold">
															...
															<li class="list-group-item">
																<div class="widget-content p-0">
																	<div class="widget-content-wrapper">
																		...
																		<div class="widget-content-left">
																			<div class="widget-heading">Masa Berlaku
																				Anggota</div>
																		</div>
																		<div
																			class="widget-content-right text-primary font-weight-bold">
															...
															<li class="list-group-item">
																<div class="widget-content p-0">
																	<div class="widget-content-wrapper">
																		...
																		<div class="widget-content-left">
																			<div class="widget-heading">Limit Lama
																				Peminjaman</div>
																		</div>
																		<div
																			class="widget-content-right text-primary font-weight-bold">
															...
															<li class="list-group-item">
																<div class="widget-content p-0">
																	<div class="widget-content-wrapper">
																		...
																		<div class="widget-content-left">
																			<div class="widget-heading">Limit Jumlah
																				Perpanjangan</div>
																		</div>
																		<div
																			class="widget-content-right text-primary font-weight-bold">
																			<?= $jenis_anggota->CountPerpanjang ?? 0; ?>
																			kali
																		</div>
																	</div>
																</div>
															...
															<li class="list-group-item">
																<div class="widget-content p-0">
																	<div class="widget-content-wrapper">
																		...
																		<div
																			class="widget-content-right text-primary font-weight-bold">
																			<?= $jenis_anggota->MaxPinjamKoleksi ?? 0; ?>
																			koleksi
																		</div>
																	</div>
																</div>
															...
															<li class="list-group-item">
																<div class="widget-content p-0">
																	<div class="widget-content-wrapper">
																		...
																		<div class="widget-content-left">
																			<div class="widget-heading">Biaya
																				Pendaftaran</div>
																		</div>
																		<div
																			class="widget-content-right text-primary font-weight-bold">
