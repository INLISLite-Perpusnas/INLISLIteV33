	...
	$html .= '		
			<td style="width:50%;">
				<table cellpadding="0" cellspacing="0" style="width:255px;" nobr="true">
					...
					<td style="width:17%;border-top:solid 1px #CCC;border-bottom:solid 1px #CCC; border-right:solid 1px #CCC;text-align: center; ' . $warna . ' " rowspan="2">' . str_replace(' ', '<br>', $LabelData['CallNumber']) . '</td>
					</tr>
					<tr>
