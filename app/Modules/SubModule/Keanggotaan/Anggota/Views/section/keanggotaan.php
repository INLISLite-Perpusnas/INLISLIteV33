<form id="frm" method="post" action="<?= base_url('anggota/edit/' . $anggota->ID) ?>">
    <div class="form-group mt-1">
        <?php if (!$is_anggota) : ?>
            <a target="_blank" href="<?= base_url('anggota/cetak-kartu/' . $anggota->ID . '?slug=template-1'); ?>" data-toggle="tooltip" data-placement="top" title="Cetak Kartu" class="btn btn-lg btn-primary"><i class="fa fa-print"></i> Cetak Kartu Anggota
            </a>
            <a href="javascript:void(0);" data-href="<?= base_url('anggota/cetak-kartu/' . $anggota->ID . '?slug=template-2'); ?>" data-toggle="tooltip" data-placement="top" title="Cetak Kartu" class="btn btn-lg btn-primary remove-data"><i class="fa fa-print"></i> Cetak Kartu Belakang
            </a>
