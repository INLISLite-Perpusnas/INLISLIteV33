    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Buku Tamu - Bukan Anggota
                    <div class="page-title-subheading">Daftar semua Buku Tamu Bukan Anggota</div>
                </div>
            </div>
            ...
            <table style="width: 100%;" id="tbl_data" class="table table-hover table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" width="120">Nama Pengunjung</th>
...
<script>
    ...
    $(document).ready(function() {
        t = $('#tbl_data').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": '<?php echo site_url('api/bukutamu/non_anggota_datatable') ?>',
            },
