        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Tambah Role
                </h5>
            ...
            <form id="frm_create" method="post" action="">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" class="form-control" id="name" name="name" placeholder="Nama Role" value="<?= set_value('name'); ?>" />
                        </div>
                    </div>
                    <div class="form-group">
