            ...
            <?php if (!empty($roweksemplar)): ?>
                <div class="card shadow-lg border-0 mb-4">
                    <div class="card-header bg-success text-white">
                        <h5 class="mb-0">
                            <i class="fas fa-book me-2"></i>Daftar Buku Fisik
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-bordered mb-0" id="tbl_eksemplars_fisik">
                                <thead class="table-dark">
                                    <tr>
                                        <th><i class="fas fa-barcode me-1"></i>Nomor Barcode</th>
                                        <th><i class="fas fa-hashtag me-1"></i>Nomor Panggil</th>
                                        <th><i class="fas fa-key me-1"></i>Akses</th>
                                        <th><i class="fas fa-map-marker-alt me-1"></i>Lokasi</th>
                                        <th><i class="fas fa-check-circle me-1"></i>Ketersediaan</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php foreach ($roweksemplar as $eksemplar): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-primary"><?= esc($eksemplar->RuleName) ?></span>
                                            </td>
                                            <td>
                                                <i class="fas fa-building me-1"></i><?= esc($eksemplar->LocationName) ?>
                                            </td>
                                            <td>
            ...
            <?php if (!empty($roweksemplar_drm)): ?>
                <div class="card shadow-lg border-0 mb-4">
                    <div class="card-header bg-info text-white">
                        <h5 class="mb-0">
                            <i class="fas fa-tablet-alt me-2"></i>Daftar Buku Digital
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                                ...
                                <tbody>
                                    <?php foreach ($roweksemplar_drm as $eksemplar_drm): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-primary"><?= esc($eksemplar_drm->RuleName) ?></span>
                                            </td>
                                            <td>
                                                <i class="fas fa-cloud me-1"></i><?= esc($eksemplar_drm->LocationName) ?>
                                            </td>
                                            <td>
                                                <span class="badge bg-success"><?= esc($eksemplar_drm->StatusName) ?></span>
                                            </td>
                                            <td>
                                                <button type="button" class="btn btn-primary btn-sm" 
                                                        data-bs-toggle="modal" data-bs-target="#pdfModal<?= $catalog['ID'] ?>">
