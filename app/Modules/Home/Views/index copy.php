            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="<?= ($index + 1) * 100 ?>">
                    <a href="<?= $module['link'] ?>" class="module-card d-block">
                        <div class="module-icon bg-<?= $module['color'] ?>">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="footer-content">
                        <h5 class="footer-title">Perpustakaan Digital</h5>
                        <p class="footer-text">
                            Menyediakan akses terbaik untuk koleksi pengetahuan dan informasi digital 
                ...
                <div class="col-lg-2 col-md-6 mb-4">
                    <div class="footer-content">
                        ...
                        <ul class="list-unstyled footer-text">
                            <li><a href="<?= base_url('opac/search') ?>" class="text-decoration-none footer-text">OPAC</a></li>
                            <li><a href="<?= base_url('buku-tamu') ?>" class="text-decoration-none footer-text">Buku Tamu</a></li>
                            <li><a href="<?= base_url('baca-ditempat') ?>" class="text-decoration-none footer-text">Baca di Tempat</a></li>
                            <li><a href="<?= base_url('membership') ?>" class="text-decoration-none footer-text">Keanggotaan</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="footer-content">
                        ...
                        <div class="footer-text">
                            ...
                            <p><i class="fas fa-envelope me-2"></i>info@perpustakaan.ac.id</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="footer-content">
                        ...
                        <div class="footer-text">
                            <p><strong>Senin - Jumat:</strong><br>08:00 - 20:00 WIB</p>
                            <p><strong>Sabtu:</strong><br>08:00 - 16:00 WIB</p>
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-md-end">
                    <p class="footer-text mb-0">
                        Developed with <i class="fas fa-heart text-danger"></i> by IT Team
                    </p>
                </div>
            </div>
        </div>
