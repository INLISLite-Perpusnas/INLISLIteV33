			...
			<table style="width: 100%;" id="tbl_loan" class="table table-hover table-bordered">
				<thead class="bg-night-sky text-light">
					<tr>
						...
						<th class="text-center" width="100">Hari Terlambat</th>
						<th class="text-center" width="150">Lokasi Perpustakaan</th>
...
<script>
	...
	$(document).ready(function() {
		t = $('#tbl_loan').DataTable({
			...
			"serverSide": true,
			"ajax": {
				"url": '<?php echo site_url('api/peminjaman-mandiri/loan_datatable/' . $member_no ?? '') ?>',
			},
