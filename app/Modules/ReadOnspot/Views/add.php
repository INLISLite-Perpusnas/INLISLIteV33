			...
			<div class="page-title-actions">
				<nav class="" aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="active breadcrumb-item" aria-current="page">Baca Ditempat</li>
					</ol>
				</nav>
			</div>
		</div>
	...
	<?php if (empty($member)) : ?>
		<div class="row">
			<div class="col-lg-4 col-md-6 col-sm-12">
				<form method="get" action="<?= base_url($prefix . 'baca-ditempat') ?>">
			...
			<div class="col-lg-12">
				<form method="post" method="post" action="">
					<div class="form-row">
						<div class="col-md-12">
							<div class="position-relative form-group">
								<label for="NomorBarcode">Nomor Barcode*</label>
								<div>
									<input type="text" class="form-control" name="NomorBarcode" id="NomorBarcode" onkeypress="return numberOnly(event)" minlength="5" required>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="select-wrapper input-group mb-3">
						...
						<button class="btn btn-primary btn-lg text-white" type="submit"><i class="fa fa-save"></i> Simpan Baca Ditempat</button>
					</div>
				</form>
			</div>
		</div>
