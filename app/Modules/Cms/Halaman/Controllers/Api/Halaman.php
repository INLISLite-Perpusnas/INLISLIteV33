...
class Halaman extends \Base\Controllers\BaseResourceController
{
    use ResponseTrait;
    ...
    public function datatable($slug = null)
    {
        ...
        $dataTable = DataTable::of($builder)
            ...
            ->edit('action', function ($row) {
                $edit =
                    '<a href="' .
                    base_url('cms/halaman/edit/' . $row->id) .
                ...
                $delete =
                    ...
                    base_url('cms/halaman/delete/' . $row->id) .
    ...
    {
        try {
            $data = $this->halamanModel->where('slug', $slug)->first();
            if ($data) {
                $response = [
                    'error' => false,
