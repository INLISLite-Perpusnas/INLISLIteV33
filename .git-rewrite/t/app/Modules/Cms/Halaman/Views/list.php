...
<div class="app-main__inner">
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Halaman <?= ucwords(unslugify($slug)) ?>
                    <div class="page-title-subheading">Daftar semua Halaman
                    </div>
                </div>
            </div>
    ...
    <div class="main-card mb-3 card">
        <div class="card-header"><i class="header-icon lnr-list icon-gradient bg-plum-plate">
            </i>Tabel Halaman <?= ucwords(unslugify($slug)) ?>
            <div class="btn-actions-pane-right actions-icon-btn">
                <?php if (is_allowed('halaman/create')) : ?>
                    <a href="<?= base_url(
                                    'cms/halaman/create?slug=' . $slug
...
<script>
    ...
    $(document).ready(function() {
        t = $('#tbl_pages').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": '<?php echo site_url('api/halaman/datatable/' . $slug); ?>',
            },
