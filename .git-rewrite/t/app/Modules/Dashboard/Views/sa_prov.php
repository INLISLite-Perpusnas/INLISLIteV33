...
$query = $builder
    ...
    ->where('branchs.NPP_Provinsi_id', $npp_provinsi_id);
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4 col-xl-4">
                <div class="card-hover-shadow-2x mb-3 card bg-night-sky">
                    <div class="rm-border responsive-center text-left card-header">
                        ...
                        <div style="text-align: right; position: absolute; right: 10px; text-transform: none"><a href="<?= base_url('katalog') ?>" class="btn btn-info btn-sm" title="Klik untuk menampilkan"><i class="fa fa-list"></i> Selengkapnya</a></div>
                    </div>
                            ...
                            <div class="widget-chart-content">
                                <div class="widget-chart-flex">
                                    <div class="widget-numbers">
                                        <div class="widget-chart-flex">
                                            <div class="text-white"><span><?= formatRupiah($total_katalog ?? 0, '') ?? 0 ?></span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-6 col-lg-4 col-xl-4">
                <div class="card-hover-shadow-2x mb-3 card bg-night-sky">
                    <div class="rm-border responsive-center text-left card-header">
                        <div>
                            <h5 class="menu-header-title text-capitalize text-dark">Total Eksemplar</h5>
                        </div>
                        <div style="text-align: right; position: absolute; right: 10px; text-transform: none"><a href="<?= base_url('eksemplar') ?>" class="btn btn-info btn-sm" title="Klik untuk menampilkan"><i class="fa fa-list"></i> Selengkapnya</a></div>
                    </div>
                    <div class="widget-chart widget-chart2 text-left pt-0">
                        <div class="widget-chat-wrapper-outer">
                            <div class="widget-chart-content">
                                <div class="widget-chart-flex">
                                    <div class="widget-numbers">
                                        <div class="widget-chart-flex">
                                            <div class="text-white"><span><?= formatRupiah($total_koleksi ?? 0, '') ?? 0 ?></span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-6 col-lg-4 col-xl-4">
                <div class="card-hover-shadow-2x mb-3 card bg-night-sky">
                    <div class="rm-border responsive-center text-left card-header">
                        ...
                        <div style="text-align: right; position: absolute; right: 10px; text-transform: none"><a href="<?= base_url('sirkulasi-peminjaman') ?>" class="btn btn-info btn-sm" title="Klik untuk menampilkan"><i class="fa fa-list"></i> Selengkapnya</a></div>
                    </div>
                    <div class="widget-chart widget-chart2 text-left pt-0">
                        <div class="widget-chat-wrapper-outer">
                            <div class="widget-chart-content">
