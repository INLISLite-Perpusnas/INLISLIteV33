                ...
                <div class="form-row">
                    <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <select class="form-control" name="category" id="category" tabindex="-1" aria-hidden="true">
                                <option value="Landscape" <?= $template->category == 'Landscape' ? 'selected' : '' ?>>Landscape</option>
                                <option value="Potrait" <?= $template->category == 'Potrait' ? 'selected' : '' ?>>Potrait</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" id="title" name="title" placeholder="Nama Template" value="<?= set_value('name', $template->title) ?>" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="position-relative form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" id="title" name="slug" placeholder="Slug" value="<?= set_value('slug', $template->slug) ?>" />
                            </div>
                        </div>
                    </div>
                </div>
