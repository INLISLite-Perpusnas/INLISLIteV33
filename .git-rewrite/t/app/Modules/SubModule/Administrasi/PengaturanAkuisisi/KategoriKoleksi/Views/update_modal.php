		...
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">
					<i class="header-icon lnr-pencil icon-gradient bg-plum-plate"> </i> Edit Kategori Koleksi
				</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<form id="frm_update" method="post" data-action="<?= base_url('api/master-kategori-koleksi/edit') ?>" data-id="">
				<div class="modal-body">
					...
					<div class="form-row">
						<div class="col-lg-12">
							<div class="form-group">
								...
								<div>
									<input required type="text" class="form-control" id="frm_update_Code" name="Code" placeholder="Kode Kategori Koleksi" value="" />
								</div>
							</div>
						</div>
					</div>
					...
					<div class="form-row">
						<div class="col-lg-12">
							<div class="form-group">
								<label for="Nama">Kategori Koleksi</label>
								<div>
									<input required type="text" class="form-control" id="frm_update_Name" name="Name" placeholder="Kategori Koleksi" value="" />
								</div>
							</div>
						</div>
					</div>
