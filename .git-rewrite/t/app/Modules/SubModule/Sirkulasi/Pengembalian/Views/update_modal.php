		...
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">
					<i class="header-icon lnr-pencil icon-gradient bg-plum-plate"> </i> Edit Pengembalian
				</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<form id="frm_update" method="post" data-action="<?= base_url('api/sirkulasi-pengembalian/edit') ?>" data-id="">
					...
					<div class="form-row">
						<div class="col-lg-6">
							<div class="form-group">
								...
								<div>
									<input required type="text" class="form-control" id="frm_update_pengembalian" name="pengembalian" placeholder="Pengembalian" value="" />
								</div>
							</div>
						</div>
						<div class="col-lg-6">
						...
						<div class="col-lg-6">
							<div class="form-group">
								<label for="UploadDokumenKeanggotaanOnline">Upload Dokumen Pengembalian</label>
								<div>
	...
	$("body").on("click", ".show-data", function() {
		...
		$.ajax({
			...
			success: function(response) {
				...
				$('#frm_update_pengembalian').val(response.pengembalian);
		...
		$.ajax({
			...
			.done(function(res) {
				...
				if (res.error == false) {
					Swal.fire({
						title: 'Berhasil',
						html: 'Pengembalian berhasil disimpan.',
						type: 'success',
