        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <i class="header-icon lnr-plus-circle icon-gradient bg-plum-plate"> </i> Tambah Peminjaman
                </h5>
                ...
                <div class="modal-body">
					...
					<div class="col-lg-6">
							<div class="form-group">
								...
								<div>
									<input required type="text" class="form-control" id="frm_add_peminjaman" name="peminjaman" placeholder="Peminjaman" value="" />
								</div>
							</div>
						</div>
						<div class="col-lg-6">
...
<script>
    $('#frm_add').submit(function(event) {
		...
		var url = "<?=base_url('api/peminjaman/create')?>";
		...
		.done(function(res) {
			...
			if (res.error == false) {
				Swal.fire({
					title: 'Berhasil',
					html: 'Peminjaman berhasil ditambah.',
					type: 'success',
